...
def get_meta_finetune_parser(default_task='translation'):
    ...
    dataset_group.add_argument('--test-subset', default='test', metavar='SPLIT',
                               help='data subset to use for testing (train, valid, test)')
    dataset_group.add_argument('--domains', nargs='*', help='List of domains to consider')
    add_distributed_training_args(parser)
    add_optimization_args(parser)
    add_checkpoint_args(parser)
    add_generation_args(parser)
...
def add_damethod_args(parser):
    ...
    group.add_argument('--translation-task', type=str, help='task in [en2de,en2zh]')
    group.add_argument('--domain-nums', default=5, type=int, help='number of domains used in mixed setting (auto adjust)')
    group.add_argument('--task-nums', type=int, help='number of domains used in mixed setting (auto adjust)')
    group.add_argument('--pre-domain-nums', default=5, type=int, help='number of domains used in mixed setting (auto adjust)')
